...
Item.prototype = {
    ...
    setState: function(direction){
        $.Velocity.hook(this.dom, 'translateY', this[direction+'State']);
    ...
    slideIn: function(direction, callback){
        this.dom.velocity({
            ...
            duration: this['durationIn'+direction]
        })
        // this.dom.animate({
    ...
    slideOut: function(direction, callback){
        this.dom.velocity({
            translateY: this[direction+'State']
        }, {
            duration: this['durationOut'+direction]
        })
        // this.dom.animate({
...
var pageAnimateArray = [{
    ...
    init: function(){
        ...
        // });
        $.Velocity.hook(this.dom, 'translateY', this.DownState);
